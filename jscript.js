...
function criaBomba(){
    if(jogo){ 
        ...
        contBombas--;
        painelContBombas.innerHMTL="Contagem de Bombas" + contBombas;
...
function controlaBomba(){
             ...
             if(bombas[i]){
                 ...
                 if(
                     (
                        ...
                        && 
                        (
                            ((tiro.offsetLeft<=bombas{i].offsetLeft+24))&&//Esquerda tiro direita bomba
                            ((tiro.offsetLeft+6)>=(bombas[i].offsetLeft))//Direita tiro esquerda bomba
                        )
                        ){
                            //console.log("colidiu");
                            criarExplosaoAr(bombas[i].offsetLeft-25,bombas[i].offsetTop);
                            bombas[i].remove();
                            tiro.remove();
                        }
                    }
    ...
    function gerenciaGame(){
        barraPlaneta.style.style.width=vidaPlaneta+"px";
        if(contBombas<=0){
            jogo=false;
    ...
    function gameLoop(){ 
        ...
        function inicia(){
            ...
            vidaPlaneta=300;
            barraPlaneta=document.getElementsById("barraPlanete");
            barraPlaneta.style.width=vidaPlaneta+"px";
            painelContBombas=document.getElementById("contBombas");
            telaMsg=document.getElementById("btnJogar").addEventListener("click",reinicia);
